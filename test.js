...
console.log(myStrings.countConsonants("the QuIck rEd fox jumped over the lazy brown dog")); 
console.log(myStrings.reverse("the QuIck rEd fox jumped over the lazy brown dog")); 